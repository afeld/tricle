...
describe Tricle::Presenters::Metric do
  ...
  describe '#days_ago' do
    it "starts and ends at midnight" do
  ...
  describe '#weeks_ago' do
    it "starts and ends on Monday" do
  ...
  describe '#week_average_this_quarter' do
    it "averages the values provided by #size_for_range" do
  ...
  describe '#day_before' do
    it 'starts and ends at midnight' do
      metric.should_receive(:size_for_range).with(Time.new(2013, 7, 30), Time.new(2013, 7, 31))
      presenter.day_before
    end
  end
end
